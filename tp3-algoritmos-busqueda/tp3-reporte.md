...
Los algoritmos informados (UCS y A*) presentaron menor costo y tiempo medio en ambos escenarios.

Los métodos no informados (DFS y sus variantes limitadas) tendieron a explorar más estados y a obtener soluciones menos óptimas.

La búsqueda aleatoria (RANDOM) resultó la menos eficiente de todas.